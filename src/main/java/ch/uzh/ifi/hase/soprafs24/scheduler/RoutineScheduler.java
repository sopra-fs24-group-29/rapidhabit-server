...
public class RoutineScheduler {
    ...
    @Scheduled(cron = "0 45 19 * * ?", zone = "Europe/Zurich") // Opening Pulse Check entries at 10:15 AM for each group
    ...
    @Scheduled(cron = "0 0 20 * * ?", zone = "Europe/Zurich") // To run at 12:00 PM every day
