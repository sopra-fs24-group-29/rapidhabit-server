...
public class RoutineScheduler {
    ...
    @Scheduled(cron = "0 29 23 * * ?", zone = "Europe/Zurich") // Opening Pulse Check entries at 10:15 AM for each group
    ...
    @Scheduled(cron = "0 30 23 * * ?", zone = "Europe/Zurich") // To run at 12:00 AM every day
