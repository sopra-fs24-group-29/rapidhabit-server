...
public class RoutineScheduler {
    ...
    @Scheduled(cron = "0 25 21 * * ?", zone = "Europe/Zurich") // Opening Pulse Check entries at 10:15 AM for each group
    ...
    @Scheduled(cron = "0 35 21 * * ?", zone = "Europe/Zurich") // To run at 12:00 PM every day
