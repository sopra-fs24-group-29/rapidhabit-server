...
## Technologies
### Backend
In the Backend we used the following technologies:
- MongoDB as Database       (because of...)
- Java (because of...)
- SpringBoot (because of...)
- usw...

### Frontend
In the Frontend we used the following technologies:
- React
- usw.
