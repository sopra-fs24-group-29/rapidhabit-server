...
|:--------|-----------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| https://github.com/sopra-fs24-group-29/rapidhabit-server/issues/16     | Create User-Objects in Database                     | [Commit bb24323c](https://github.com/sopra-fs24-group-29/rapidhabit-server/commit/bb24323c9bf5be7dd886829b79b4ecc1cb41a13f)
 - POST Mapping "/users" - CODE 204 CREATED (Pass)  <br> - POST Mapping "/users" - CODE 409 CONFLICT (error)                                                                                         |
